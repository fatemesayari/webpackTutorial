...
var _kbnI18n = require("@cybernetex/kbn-i18n");
 ...
 * under the License.
 */
const endOfInputText = _kbnI18n.i18n.translate('kbnESQuery.kql.errors.endOfInputText', {
...
class KQLSyntaxError extends Error {
  constructor(error, expression) {
    const grammarRuleTranslations = {
      fieldName: _kbnI18n.i18n.translate('kbnESQuery.kql.errors.fieldNameText', {
        defaultMessage: 'field name'
      }),
      value: _kbnI18n.i18n.translate('kbnESQuery.kql.errors.valueText', {
        defaultMessage: 'value'
      }),
      literal: _kbnI18n.i18n.translate('kbnESQuery.kql.errors.literalText', {
        defaultMessage: 'literal'
      }),
      whitespace: _kbnI18n.i18n.translate('kbnESQuery.kql.errors.whitespaceText', {
    ...
    const message = _kbnI18n.i18n.translate('kbnESQuery.kql.errors.syntaxError', {
